...
#define WIFI_SSID             "Tanimun"
#define WIFI_PASSWORD         "Sayed@1599"

/* 2. Define the API Key */
#define API_KEY               "AIzaSyAOPdIgVACn7WqCIRFkupmeUhh-WKO26kY"
...
#define STORAGE_BUCKET_ID     "fota-final-6661b.appspot.com"
...
void Send_CMD_Upload_Application()
{
    ...
    if (Firebase.ready())
    {
        ...
        if (!Firebase.Storage.download(&fbdo, STORAGE_BUCKET_ID /* Firebase Storage bucket id */, "NApplication.bin" /* path of remote file stored in the bucket */, "/update.bin" /* path to local file */, mem_storage_type_flash /* memory storage type, mem_storage_type_flash and mem_storage_type_sd */, fcsDownloadCallback /* callback function */))
